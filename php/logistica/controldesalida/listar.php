<?php
  ...
  function nacional($conexion_usuarios){
    ...
    $query = "SELECT DISTINCT folio, proveedor FROM utilidad_pedido WHERE (folio != '' OR folio != 0) AND fecha_orden_compra >='$fechaInicio' AND fecha_orden_compra <= '$fechaFin' ORDER BY id DESC LIMIT 250";
