<?php 
	...
	$sql="SELECT utilidad_pedido.*, contactos.nombreEmpresa FROM utilidad_pedido LEFT JOIN contactos on contactos.id=utilidad_pedido.proveedor WHERE orden_compra='".$ordenCompra."'";
