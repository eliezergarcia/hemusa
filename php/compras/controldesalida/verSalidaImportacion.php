...
<html lang="es">
<head>
  <title>Salida Importación</title>
      ...
      <div class="page-head">
          ...
          <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
                ...
                <li class="breadcrumb-item"><a href="#">Salida Importación</a></li>
            </ol>
          </nav>
      </div>
...
<?php include('../../enlacesjs.php'); ?>
	<script type="text/javascript">
      ...
      var pedimento = "<?php echo $_REQUEST['pedimento']; ?>";
			var opcion = "partidasimportacion";
