	...
	<script type="text/javascript">
		...
		function genPDF(opcionPDF) {
			...
			$.ajax({
				...
				doc.text("HERRAMIENTAS MECANICAS UNIVERSALES S.A. DE C.V.", 80, 45);
				doc.setFontSize(17);
				doc.text("COTIZACION", 250, 70);
				...
				doc.setFontSize(10);
				doc.setFontStyle('bold');
				doc.text("Fecha:", 355, 95);
				doc.text("Vendedor:", 355, 110);
				doc.text("Número cotización:", 355, 125);
				doc.text("Vencimiento:", 355, 140);
				doc.setFontStyle('normal');
				doc.text(data.fecha, 475, 95);
				doc.text(data.cotizacion.vendedor, 475, 110);
				doc.text(data.cotizacion.ref, 475, 125);
				doc.text(data.vencimiento, 475, 140);
				doc.setFontSize(10);
				doc.setFontStyle('bold');
				doc.text("Cliente", 20, 210);
				doc.text("Condiciones de pago", 395, 245);
				doc.setFontSize(8);
				doc.setFontStyle('normal');
				doc.text(data.cliente.nombreEmpresa, 20, 225);
				if (data.cotizacion.CondPago == 0) {
					doc.text("Contado", 435, 260);
				}else{
					doc.text(data.cotizacion.CondPago + " días", 435, 260);
				}
				doc.text(data.cliente.RFC, 20, 240);
				doc.setFontStyle('bold');
				doc.setFontSize(10);
