...
$insertSQL = "INSERT INTO Precio".$productor." (ref,precioBase,descripcion,enReserva,clase, CantidadMinima) VALUES ('$ref',$precioBase,'$descripcion','$enReserva','$clase', '$cantidad_minima')";
   ...
   mysql_query($inventario_inicial);
	...
	while ($rowId = mysql_fetch_array($resultId)) {
  	 ...
  	 $sQlProductos= "INSERT INTO productos (Idmarca, IdTablaMarca, marca, ref, descripcion, precioBase, enReserva, clase, fecha, factor, moneda, EnPortal, CantidadMinima) VALUES ('".$Idmarca."' , ".$IdTablaMarca.",'".$productor."','".$ref."','".$descripcion."','".$precioBase."','".$enReserva."', '".$clase."', '".$fecha."','".$FactorMarca."', '".$monedaMarca."', '".$EnPortal."', '".$cantidad_minima."')";
