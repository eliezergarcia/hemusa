...
//marca en la funcion mostrar marca
  ...
  echo '<form action="solicitud_inventario.php" method="post">';  
  echo '<tr><td> Marca </td>';
  echo '<td> '.$marca.'</td>';
  ...
  echo '<td><input type="checkbox" name="agregar_pieza" value="sumar"   /> AGREGAR INVENTARIO ';
  echo '<input type="checkbox" name="quitar_pieza" value="restar"  /> 	QUITAR AL INVENTARIO </td>';
