...
$insertSQL=strtolower($insertSQL);
...
<td>Clase</td><td>Cantidad min.</td><td>Unidad</td>
<td>IGI</td>";
echo "</tr>";
...
if(mysql_num_rows($result_igi) == 0){
	$id_igi=0;
}
...
$porcentaje=$igi_modelo*100;
	 ...
	 echo "<td><center>".$row['clase']."</center></td>";
		echo "<td><center>".$row['CantidadMinima']."</center></td>";
		echo "<td><center>".$row['Unidad']."</center></td>";
...
echo "<form action='../precios.php?palabraBusca=".$ref."&buscar=Buscar&marcaBuscar=".$productor."' name='precio' method='post'>";
...
<td valign="top" align="right"><input type="text" name="CantidadMinima" size="7" value=""></td>

<td valign="top" align="right"><input type="text" name="Unidad" size="10" value="" placeholder="PIEZA/JUEGO"></td>
