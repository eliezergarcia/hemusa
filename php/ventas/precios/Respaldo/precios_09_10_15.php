...
do{
 ...
 $marcaBuscar= implode($cadena);
	...
	echo '<table border="0" cellpadding="1" cellspacing="0" summary="" frame="border" width="85%">';
...
if ($refBusca!='') {
   ...
   if ($row['category']==$cat || $cat=='') {
		...
		echo $precioUnidad;
			echo "</td><td align='right'><b>".round(($row['precioBase']*$r['factor'])*(1+$IVA)).".00</b></td><td align=right>".$row['enReserva']."</td><td align=right style='color: '#070707'>".$r['moneda']."</td>";
		...
		elseif($color=="D"){
			echo "<td align=right>";
			 ...
			 echo "<td align=right style='color: '#070707'>".$row['clase']."</td>";
			...
			while ($row = mysql_fetch_array($result)) {
				...
				$i=0;
 				if (strstr($test,$word1) and (strstr($test,$word2) or $word2==' ') and (strstr($test,$word3) or $word3==' ') and (strstr($test,$word4) or $word4==' ') and (strstr($test,$word5) or $word5==' ')) {
					...
					echo $precioUnidad;
  					echo "</td><td align='right'><b>".number_format(($row['precioBase']*$r['factor'])*(1+$IVA),2)."</b></td><td align=right>".$row['enReserva']."</td><td align=right style='color: '#070707'>".$r['moneda']."</td>";
					
					
					//<td align=right style='color: '#070707' style='font-weight: bold'>".$row['clase']."</td>
